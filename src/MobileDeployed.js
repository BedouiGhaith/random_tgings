...
const MobileDeployed = ({ data, projets }) => {
    ...
    const usersInMobileProjects = checkUsersInProjects(projets, filterData(data)[1].developers);
    ...
    const createChart = () => {
        const chartOptions = {
            ...
            series: [usersInMobileProjects.length*100/filterData(data)[1].count,(filterData(data)[1].count-usersInMobileProjects.length)*100/filterData(data)[1].count],
